...
class_t archClass = CPU_UNKNOWN; // xeon or core
...
int determine_class_uarch(int cpu_model) {
    ...
    case 142:
    case 158:
        archClass = INTEL_CORE;
        break;
    default:
        archClass = CPU_UNKNOWN;
...
int setup_perf_counters(class_t archClass, uarch_t archi, int nb_cores) {

    // Xeons
    if (archClass == INTEL_XEON) {
